...
const Dashboard = ({ navigation }) => {
    ...
    const [countries, setCountries] = useState([ {id: -1} , ... 
        ...
        const [places, setPlaces] = useState([{id: -1}, 
            ...dummyData.countries[0].places, {id:-2}])
        ...
        return(
            <Animated.FlatList
                ...
                onMomentumScrollEnd={(event) =>{
                    ...
                    var position = (event.nativeEvent.
                        contentOffset.x / COUNTRIES_ITEM_SIZE).toFixed(0)
                ...
                renderItem={({item,index}) => {
                    ...
                    const mapSize = countryScrollX.interpolate({
                        inputRange: [
                         ...
                         outputRange: [25, Platform.OS == 'android' ? 60 : 30, 25],
                         extrapolate: 'clamp'
                    })
        ...
        return (
            <Animated.FlatList 
                ...
                onMomentumScrollEnd={(event) =>{
                    ...
                    var position = (event.nativeEvent.
                        contentOffset.x / PLACES_ITEM_SIZE).toFixed(0)
                    ...
                    return (
                        ...
                        style={{
                            ...
                            marginHorizontal:SIZES.padding}}>
                                <Text
                                style={{marginBottom:SIZES.radius, color:COLORS.white,
                                    ...FONTS.h1
                                }}>{item.name}
                                </Text>
       ...
       <SafeAreaView style={{ flex: 1, backgroundColor:COLORS.black }}>
           ...
           <ScrollView contentContainerStyle={{
               ...
               <View style={{ height: 110 }}>
                ...
                <View style={{height: Platform.OS === 'android' ? 500 : 45 }}
                >{renderPlaces()}</View>
           </ScrollView>
       </SafeAreaView>
    )
