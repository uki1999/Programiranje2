...
public class MaloTezaPitanjaGeografija extends AppCompatActivity{
    private maloTezaPitanjaGeografija1 mQuestionLibary4 = new maloTezaPitanjaGeografija1();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.malo_teza_pitanja_geografija);
        rn = new Random();
    ...
    private void updateQuestion() {
        if (mQuestionNumber4 < mQuestionLibary4.getLength()) {
            ...
            mAnswer = mQuestionLibary4.getCorrectAnswers4(mQuestionNumber4);
            mQuestionNumber4++;
        }else{
            NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(MaloTezaPitanjaGeografija.this)
            ...
            NotificationManagerCompat notificationManager = NotificationManagerCompat.from(MaloTezaPitanjaGeografija.this);
            ...
            Toast.makeText(MaloTezaPitanjaGeografija.this, "Vas rezultat je:"+ mScore7, Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(MaloTezaPitanjaGeografija.this, VeciSkorActivity5.class);
    ...
    public void onClick(View view) {
        ...
        //sound that makes when the question is right or wrong
        final MediaPlayer mp = MediaPlayer.create(MaloTezaPitanjaGeografija.this, R.raw.true_sound);
        final MediaPlayer mp2 = MediaPlayer.create(MaloTezaPitanjaGeografija.this,R.raw.false_sound);

        if (answer.getText() == mAnswer) {
            mScore7 = mScore7 + 1;
            mScore700 = mScore700 + 2;
            Toast.makeText(MaloTezaPitanjaGeografija.this, "Super!", Toast.LENGTH_SHORT).show();
            updateScore(mScore7);
            mp.start();
            updateQuestion();
        } else {
            Toast.makeText(MaloTezaPitanjaGeografija.this, "Greska!", Toast.LENGTH_SHORT).show();
            updateScore(mScore7);
            mp2.start();
            updateQuestion();
        }
