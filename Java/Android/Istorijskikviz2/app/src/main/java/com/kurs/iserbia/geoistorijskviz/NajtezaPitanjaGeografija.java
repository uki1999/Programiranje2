...
public class NajtezaPitanjaGeografija extends AppCompatActivity {

    private najtezaPitanjaGeografija1 mQuestionLibary4 = new najtezaPitanjaGeografija1();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.najteza_pitanja_geografija);
        rn = new Random();
    ...
    private void updateQuestion(Random rn) {
        if (mQuestionNumber4 < mQuestionLibary4.getLength()) {
            ...
            NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(NajtezaPitanjaGeografija.this)
            ...
            NotificationManagerCompat notificationManager = NotificationManagerCompat.from(NajtezaPitanjaGeografija.this);
            ...
            Toast.makeText(NajtezaPitanjaGeografija.this, "Vas rezultat je:"+ mScore7, Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(NajtezaPitanjaGeografija.this, VeciSkorActivity6.class);
    ...
    public void onClick(View view) {
        ...
        final MediaPlayer mp = MediaPlayer.create(NajtezaPitanjaGeografija.this, R.raw.true_sound);
        final MediaPlayer mp2 = MediaPlayer.create(NajtezaPitanjaGeografija.this,R.raw.false_sound);

        if (answer.getText() == mAnswer) {
            mScore7 = mScore7 + 1;
            mScore700 = mScore700 + 3;
            Toast.makeText(NajtezaPitanjaGeografija.this, "Super!", Toast.LENGTH_SHORT).show();
            mp.start();
            updateScore(mScore7);
            updateQuestion(rn);
        } else {
            Toast.makeText(NajtezaPitanjaGeografija.this, "Greska!", Toast.LENGTH_SHORT).show();
            mp2.start();
            updateScore(mScore7);
            updateQuestion(rn);
        }
