...
public class quickSort {
	...
	public static void main(String[] args) {
		...
		//Pomoæu funkcije quickSort sortiramo celu listu
	...
	public static void quickSort(Integer[] arr, int low, int high) {
		//Gledamo da li možda u listi imaju null vrednosti
		...
		//Tražimo srednju vrednost liste, tj.sredinu
		...
		while(i <= j) {
			...
			//vrednosti desne strane da budu veæe od pivota
			while(arr[j] > pivot) {
				j--;
			}
			//i ovde se uporeðuju vrednosti i gledaju se vrednosti koje se menjaju
